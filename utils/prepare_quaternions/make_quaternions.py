"""
Functions to compute quaternions and save them as a {SUBSET}.quat file from
a {SUBSET}.skels file containing sequences of 3d coordinates of joints and counter value.
"""
...
# To compute the mean lengths of the bones in the skeletal poses data
def compute_mean_bones_lengths(
    ...
    for subset in subsets:
        ...
        print(f"Computed mean bones lengths for '{subset}' data!")
