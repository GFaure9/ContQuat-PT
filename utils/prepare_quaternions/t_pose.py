"""
Function to compute reference T-poses from predefined structures.

Available structures for which it is possible to compute T-pose are listed in `VALID_NAMES`.
Feel free to define your own structures by updating the `T_POSES_TRANSLATIONS`
and `SKEL_STRUCTURES` dictionaries.
"""


import numpy as np

from . import ORIGINAL_S2SL_SKEL
