...
from . import make_skel_video, stack_videos
from ..prepare_quaternions import ORIGINAL_S2SL_SKEL, generate_t_pose, quaternion_to_cartesian_pose
...
def make_verif_videos(
    ...
    with (
        ...
        print("Matching number of examples for all modalities!")
        print(f"Total number of {subset} examples = {n_files}")
        ...
        for lines in zip(
            ...
            if line_id in verif_examples_ids:
                ...
                if not os.path.isdir(subfolder):
                    os.mkdir(subfolder)
                    print(f"Created sample verification folder at: {subfolder}")
                else:
                    print(f"{subfolder} already exists. Using it")
                ...
                print(f"Successfully created skeletal poses video in {subfolder}!")
                ...
                print(f"Successfully created skeletal final sample video in {subfolder}!")
                ...
                if quaternions_verif:
                    ...
                    print(f"Successfully created reconstructed (from quaternions) poses video in {subfolder}!")
                    ...
                    print(f"Successfully created original VS quaternion-based poses video in {subfolder}!")
                ...
                if os.path.exists(temp_poses_video):
                    ...
                    print(f"Removed temporary file: {temp_poses_video}")
