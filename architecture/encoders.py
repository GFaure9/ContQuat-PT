"""
Definition of encoders classes. Original code from https://github.com/BenSaunders27/ProgressiveTransformersSLP
"""
...
class TransformerEncoder(Encoder):
    ...
    def forward(
        ...
        :param embed_src: embedded src inputs, shape=(batch_size, src_len, embed_size)
        :param src_length: length of src inputs (counting tokens before padding), shape=(batch_size)
        :param mask: indicates padding areas (zeros where padding), shape=(batch_size, src_len, embed_size)
        :return:
